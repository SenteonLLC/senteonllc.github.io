...
7) Once the Endpoint's status has been verified, you can continue to initialization of the endpoint and control setup.  
...
1) On the Uninitialized Screen, all endpoints ready for setup with be listed in the top list.
